...
public class HSIView extends JPanel {
    ...
    public HSIView(UI ui) {
        ...
        scaleFactorjSpinner.setModel(new SpinnerNumberModel(10000, 0.001, 9999999.0, 1));

        ratioMaxjSpinner.setModel(new SpinnerNumberModel(1.0, 0.001, 9999999.0, 1));
        ratioMinjSpinner.setModel(new SpinnerNumberModel(0.0, 0.0, 9999999.0, 1));
   ...
   private void initComponents() {
      ...
      ratioMaxjSpinner = new javax.swing.JSpinner();
      ...
      scaleFactorjSpinner = new javax.swing.JSpinner();
      ...
      ratioMaxjSpinner.setToolTipText("Max Ratio in HSI");
      ratioMaxjSpinner.addChangeListener(new javax.swing.event.ChangeListener() {
         public void stateChanged(javax.swing.event.ChangeEvent evt) {
            ratioMaxjSpinnerStateChanged(evt);
         }
      });
      ...
      medianFilterjButton.setText("Medianize");
      ...
      scaleFactorjSpinner.setModel(new javax.swing.SpinnerNumberModel(Double.valueOf(10000.0d), Double.valueOf(0.001d), null, Double.valueOf(1.0d)));
      scaleFactorjSpinner.addChangeListener(new javax.swing.event.ChangeListener() {
         public void stateChanged(javax.swing.event.ChangeEvent evt) {
            scaleFactorjSpinnerStateChanged(evt);
         }
      });
            ...
            .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
               ...
               .add(org.jdesktop.layout.GroupLayout.TRAILING, layout.createSequentialGroup()
                     ...
                     .add(layout.createSequentialGroup()
                        ...
                        .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                           ...
                           .add(layout.createSequentialGroup()
                              ...
                              .add(jLabel4)
                              .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                              .add(ratioMaxjSpinner, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 77, Short.MAX_VALUE)
                              .add(30, 30, 30)
                              .add(jLabel5)
                              .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                     ...
                     .add(layout.createSequentialGroup()
                        .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING, false)
                           .add(layout.createSequentialGroup()
                              ...
                              .add(scaleFactorjSpinner, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 70, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                  ...
                  .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                     ...
                     .add(medianRadiusjSpinner, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 39, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                  .add(78, 78, 78))))
      );

      layout.linkSize(new java.awt.Component[] {denThresholdjSpinner, numThresholdjSpinner, ratioMaxjSpinner, ratioMinjSpinner}, org.jdesktop.layout.GroupLayout.HORIZONTAL);
      ...
      layout.setVerticalGroup(
         ...
         .add(layout.createSequentialGroup()
            ...
            .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
               .add(jLabel1)
               .add(scaleFactorjSpinner, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
            .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
            .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
               .add(jLabel6)
               .add(layout.createSequentialGroup()
                  .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                     .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                        .add(ratioMaxjSpinner, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .add(jLabel3)
                        .add(jLabel4))
                     .add(jLabel5)
                     .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
    ...
    private void ratioMaxjSpinnerStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_ratioMaxjSpinnerStateChanged
       if (bUpdating) {
            return;
        }
        props.setMaxRatio(new Double(ratioMaxjSpinner.getValue().toString()));
        update(false);
}//GEN-LAST:event_ratioMaxjSpinnerStateChanged
...
private void scaleFactorjSpinnerStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_scaleFactorjSpinnerStateChanged
    if (bUpdating) return;
    props.setRatioScaleFactor((Double)scaleFactorjSpinner.getValue());
    
    MimsPlus[] hsiImages = ui.getOpenHSIImages();
    for( int i = 0; i< hsiImages.length; i++) {
       if (hsiImages[i].getDenMass() == props.getDenMass() && hsiImages[i].getNumMass() == props.getNumMass()) {
          update(false);
    ...
    for( int i = 0; i< ratioImages.length; i++) {
       if (ratioImages[i].getDenMass() == props.getDenMass() && ratioImages[i].getNumMass() == props.getNumMass()) {
          computeRatio();
       }
    }
}//GEN-LAST:event_scaleFactorjSpinnerStateChanged
...
public synchronized void update(boolean bUpdateUI) {
        ...
        bUpdating = true ;
        if(bUpdateUI) {     
            ratioMaxjSpinner.setValue(props.getMaxRatio());
            ratioMinjSpinner.setValue(props.getMinRatio());
            scaleFactorjSpinner.setValue((double)props.getRatioScaleFactor());
    ...
    public boolean getRatioRange() {
        ...
        double sf = props.getRatioScaleFactor();
        if ( sf < 0)
           sf = ui.getRatioScaleFactor();
        if(numPixels.length != denPixels.length) {
            return false;
        }
        for(int i = 0 ; i < numPixels.length ; i++ ) {
            if(numPixels[i] > nt && denPixels[i] > dt) {
                double r = sf * ((double)numPixels[i]/(double)denPixels[i]);
                if(r > rmax) {
                    rmax = r;
                }
                else if( r < rmin ) {
    ...
    public void setHSIProps(HSIProps props) {
        ...
        System.out.println("Numerator = " + props.getNumMass());
        System.out.println("Denomator = " + props.getDenMass());
        System.out.println();
        update(true);
    }
    ...
    public void setScaleFactor(double d) {
       bUpdating = true;
       scaleFactorjSpinner.setValue(d);
       bUpdating = false;
    }
   ...
   private javax.swing.JSpinner ratioMaxjSpinner;
   ...
   private javax.swing.JSpinner scaleFactorjSpinner;
