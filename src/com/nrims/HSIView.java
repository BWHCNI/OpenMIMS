...
public class HSIView extends JPanel {
   ...
   private void initComponents() {
         ...
         .add(layout.createSequentialGroup()
            ...
            .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
               ...
               .add(layout.createSequentialGroup()
                  .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                     .add(layout.createSequentialGroup()
                        .add(rgbMinjLabel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 142, Short.MAX_VALUE)
                        .add(285, 285, 285))
                     .add(layout.createSequentialGroup()
    ...
    private void rgbMaxjSliderStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_rgbMaxjSliderStateChanged
        ...
        if (rgbMaxjSlider.getValueIsAdjusting()) {
            return;
        }
        // Ensure min <= max.
        final int limit = rgbMinjSlider.getValue();
        if (val < limit) {
            javax.swing.SwingUtilities.invokeLater(new Runnable() {

                public void run() {
                    rgbMaxjSlider.setValue(limit + 1);
                }
            });
            props.setMinRGB(limit + 1);
            rgbMaxjLabel.setText("RGB Max: " + (limit+1));
...
// TODO add your handling code here:
    ...
    if (rgbMinjSlider.getValueIsAdjusting()) {
        return;
    }
    // Ensure min <= max.
    final int limit = rgbMaxjSlider.getValue();
    if (val > limit) {
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                rgbMinjSlider.setValue(limit-1);
            }
        });
        props.setMinRGB(limit-1);
        rgbMinjLabel.setText("RGB Min: "+(limit-1));
        update(false);
        return;
    }
