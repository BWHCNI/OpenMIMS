...
private void hsiWindowjSpinnerStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_hsiWindowjSpinnerStateChanged
    ...
    props.setWindowSize((Integer) this.hsiWindowjSpinner.getModel().getValue());
    //updateInternalImages();
    update(false);
    updateInternalImages();
    displayHSI();
...
public synchronized void update(boolean bUpdateUI) {
        ...
        if(bUpdateUI) {     
            ...
            hsiWindowjSpinner.getModel().setValue(props.getWindowSize());
        }
        
        displayHSIjButton.setEnabled(props.getNumMass() != props.getDenMass());
    ...
    public void updateInternalImages() {
        ...
        if ((hsiIndex != -1) && (ui.getHSIImage(hsiIndex) != null)) {
            ui.getHSIImage(hsiIndex).recomputeInternalImages();
            //ui.computeHSI(props);
        }
    }
