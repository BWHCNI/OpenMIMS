...
public class SegmentationSetupForm extends javax.swing.JDialog {
    ...
    public SegmentationSetupForm(java.awt.Frame parent, SegmentationForm form, MimsRoiManager roiManager, ClassManager classes, boolean[] massImageFeatures,
            boolean[] ratioImageFeatures, int[] localFeatures, int colorImageIndex, SegmentationProperties props, String[] massNames) {
        super(parent, false);
        initComponents();
        ...
        // # HARD CODED #
        massImageLabels = massNames;      
        checkbox1.setLabel("Mass "+massNames[0]);

        checkbox2.setLabel("Mass "+massNames[1]);
        checkbox3.setLabel("Mass "+massNames[2]);
        checkbox4.setLabel("Mass "+massNames[3]);
        ratioImageLabels = new String[]{"Ratio "+massNames[1]+" / "+massNames[0], "Ratio "+massNames[3]+" / "+massNames[2]};
        checkbox5.setLabel(ratioImageLabels[0]);
        checkbox6.setLabel(ratioImageLabels[1]);
        massBoxes = new Checkbox[]{checkbox1, checkbox2, checkbox3, checkbox4};
        ratioBoxes = new Checkbox[]{checkbox5, checkbox6};
    ...
    private void initComponents() {
        ...
        checkbox1.setLabel("Mass 12");

        checkbox2.setLabel("Mass 13");

        checkbox3.setLabel("Mass 26");

        checkbox4.setLabel("Mass 27");

        checkbox5.setLabel("Ratio 13/12");

        checkbox6.setLabel("Ratio 27/26");
                    ...
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel2Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(checkbox5, javax.swing.GroupLayout.DEFAULT_SIZE, 107, Short.MAX_VALUE))
                            .addGap(36, 36, 36))
                        .addGroup(jPanel2Layout.createSequentialGroup()
                            .addGap(117, 117, 117)
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(syncButton, javax.swing.GroupLayout.PREFERRED_SIZE, 0, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(classesCombo, 0, 231, Short.MAX_VALUE))
                        .addGap(4, 4, 4)))
                .addContainerGap())
        );
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(enginesCombo, 0, 121, Short.MAX_VALUE)
                    .addComponent(setupButton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 121, Short.MAX_VALUE))
                .addContainerGap())
        );
