                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(70, 70, 70)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(jButtonRun, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGap(12, 12, 12)
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(jPanel1Layout.createSequentialGroup()
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            .addGap(18, 18, 18)
                            .addComponent(jButtonRun, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
...
private void jButtonAddFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddFileActionPerformed
    try {
        ...
        if (currentFile != null) {
            myFile = currentFile;
            /*
        this.myFiles.add(currentFile);//GEN-LAST:event_jButtonAddFileActionPerformed
       */
...
//                }
        ...
        while (iti.hasNext()) {
            ...
            boolean running = true;
            BufferedReader bfr = new BufferedReader(new FileReader(file));
            BufferedWriter bfw1 = new BufferedWriter(new FileWriter(file.getAbsoluteFile() + 
                    pathEnding, true));
...
// TODO add your handling code here:
    ...
    private void runSetup(boolean[] setup, TableModel parameters, String path) throws IOException {
        ...
        if (setup[10]) {
            Runtime.getRuntime().exec(".//nrims/home3/pgormanns/libsvm-2.86/easy.py " + path + 
                    "_N2_Rad_G1 test10 ");
        }
        if (setup[31]) {
            Runtime.getRuntime().exec(".//nrims/home3/pgormanns/libsvm-2.86/easy.py " + path + 
...
//            Runtime.getRuntime().exec(".//nrims/home3/pgormanns/libsvm-2.86/easy.py "+path+"_Sig test37");
        ...
        while (running) {
            ...
            if (setup[10]) {
                Runtime.getRuntime().exec(".//nrims/home3/pgormanns/libsvm-2.86/svm_scale >" + 
                        path + "_N2_Rad_G1.scale " + path + "_N2_Rad_G1");
                Runtime.getRuntime().exec(".//nrims/home3/pgormanns/libsvm-2.86/svm_train -c" + c + 
                        " -g" + g + " " + path + "_N2_Rad_G1.scale " + path + "_N2_Rad_G1_" + c + g + ".model");
                Runtime.getRuntime().exec(".//nrims/home3/pgormanns/libsvm-2.86/svm_scale > test10.scale test10");
                Runtime.getRuntime().exec(".//nrims/home3/pgormanns/libsvm-2.86/svm_predict test10.scale" + 
                        path + "_N2_Rad_G1_" + c + g + ".model " + path + "_N2_Rad_G1_" + c + g +
                        ".predict");
            }
            if (setup[31]) {
                Runtime.getRuntime().exec(".//nrims/home3/pgormanns/libsvm-2.86/svm_scale >" + path +
                        "_N2_Rad.scale " + path + "_N2_Rad");
                Runtime.getRuntime().exec(".//nrims/home3/pgormanns/libsvm-2.86/svm_train -c" + 
                        c + " -g" + g + " " + path + "_N2_Rad.scale " + path + "_N2_Rad_" + c + g + 
                        ".model");
                Runtime.getRuntime().exec(".//nrims/home3/pgormanns/libsvm-2.86/svm_scale > test31.scale test31");
                Runtime.getRuntime().exec(".//nrims/home3/pgormanns/libsvm-2.86/svm_predict test31.scale" + 
                        path + "_N2_Rad_" + c + g + ".model " + path + "N2_Rad_" + c + g + ".predict");
            }
            if (setup[37]) {
                Runtime.getRuntime().exec(".//nrims/home3/pgormanns/libsvm-2.86/svm_scale >" + 
                        path + "_Rad_G1.scale " + path + "_Rad_G1");
                Runtime.getRuntime().exec(".//nrims/home3/pgormanns/libsvm-2.86/svm_train -c" + 
                        c + " -g" + g + " " + path + "_Rad_G1.scale " + path + "_Rad_G1_" + 
                        c + g + ".model");
                Runtime.getRuntime().exec(".//nrims/home3/pgormanns/libsvm-2.86/svm_scale > test37.scale test37");
                Runtime.getRuntime().exec(".//nrims/home3/pgormanns/libsvm-2.86/svm_predict test37.scale" + 
                        path + "_Rad_G1_" + c + g + ".model " + path + "_Rad_G1_" + c + g + ".predict");
            }

            if (setup[46]) {
                Runtime.getRuntime().exec(".//nrims/home3/pgormanns/libsvm-2.86/svm_scale >" + 
                        path + "_Rad.scale " + path + "_Rad");
                Runtime.getRuntime().exec(".//nrims/home3/pgormanns/libsvm-2.86/svm_train -c" + 
                        c + " -g" + g + " " + path + "_Rad.scale " + path + "_Rad_" + c + g + ".model");
                Runtime.getRuntime().exec(".//nrims/home3/pgormanns/libsvm-2.86/svm_scale > test46.scale test46");
                Runtime.getRuntime().exec(".//nrims/home3/pgormanns/libsvm-2.86/svm_predict test46.scale" + 
                        path + "_Rad_" + c + g + ".model " + path + "_Rad_" + c + g + ".predict");
            }
        }
