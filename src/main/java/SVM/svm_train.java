...
//            }
    ...
    public svm_model run(SegmentationProperties props, List<String> data) throws IOException {
        double bestAcc = 0.0;
        int bestg = 0;
        int bestc = 0;
        this.data = data;
...
//testing parameter search
        ...
        System.out.println("starting run in svm_train " + dateFormat.format(cal.getTime()));
        int gridmethod = 1;
        ...
        System.out.println("finished svm_train run " + dateFormat.format(cal.getTime()));
