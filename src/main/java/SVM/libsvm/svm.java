...
class Solver {
    ...
    void Solve(int l, QMatrix Q, double[] p_, byte[] y_,
        ...
        System.out.println("starting solve in svm " + dateFormat.format(cal.getTime()));
        ...
        System.out.println(" solve (optimization) finished in svm " + dateFormat.format(cal.getTime()));
