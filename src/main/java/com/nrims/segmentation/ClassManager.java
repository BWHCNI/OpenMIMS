...
public class ClassManager implements Cloneable {
    ...
    public boolean renameClass(String oldName, String newName) {
        ...
        if (segClass == null || oldName.equals(newName) || getSegClass(newName) != null) {
            return false;
        } else {
    ...
    private SegClass getSegClass(String className) {
        for (SegClass segClass : classes) {
            if (segClass.name.equals(className)) {
                return segClass;
            }
        }
        return null;
