...
public class FileDrop {
     ...
     * <var>c</var> is a {@link java.awt.Container}, recursively sets all elements contained within as drop targets,
     ...
     * <tt>java.awt.Container</tt>, then each of its children components will also listen for drops, though only the
     * parent will change borders. With Debugging turned on, more status messages will be displayed to
     * <tt>out</tt>. A common way to use this constructor is with
     * <tt>System.out</tt> or <tt>System.err</tt>. A <tt>null</tt> value for the parameter <tt>out</tt> will result in
     * no debugging output.
     *
     ...
     * status messages will be displayed to
     * <tt>out</tt>. A common way to use this constructor is with
     * <tt>System.out</tt> or <tt>System.err</tt>. A <tt>null</tt> value for the parameter <tt>out</tt> will result in
     * no debugging output.
     *
    ...
    public static class Event extends java.util.EventObject {
        ...
        /**
         * Constructs an {@link Event} with the array of files that were dropped and the {@link FileDrop} that initiated
         * the event.
         *
     ...
     *      ...
     * </code></pre> Or if you need to know when the data was actually dropped, like when you're moving data out of a
     * list, say, you can use the {@link TransferableObject.Fetcher} inner class to return your object Just in Time. For
     * example:
     * <pre><code>
     *      ...
    ...
    public static class TransferableObject implements java.awt.datatransfer.Transferable {
        ...
        /**
         * Returns the data encapsulated in this {@link TransferableObject}. If the {@link Fetcher} constructor was
         * used, then this is when the {@link Fetcher#getObject getObject()} method will be called. If the requested
         * data flavor is not supported, then the {@link Fetcher#getObject getObject()} method will not be called.
         *
         ...
         * exactly when your data was received in case you need to remove it from its source (or do anyting else to it).
         * When the {@link #getTransferData getTransferData(...)} method is called on the {@link TransferableObject},
